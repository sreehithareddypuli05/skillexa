    ...
    <div className="min-h-screen hero-bg flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-2xl p-8 border border-transparent dark:border-gray-700">
          {error && (
            <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 text-red-600 dark:text-red-400 rounded-xl p-4 mb-5 text-sm flex items-start gap-2">
              <span>⚠️</span> {error}
            </div>
          )}
          ...
          <div className="mt-6 text-center text-sm">
            ...
            <Link to="/signup" className="text-blue-600 dark:text-blue-400 hover:text-blue-700 font-semibold">Create one free →</Link>
          </div>

          <div className="mt-4 pt-4 border-t border-gray-100 dark:border-gray-700 text-center">
            <Link to="/" className="text-xs text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-colors">← Back to Skillexa</Link>
          </div>
        </div>
      </div>
    </div>

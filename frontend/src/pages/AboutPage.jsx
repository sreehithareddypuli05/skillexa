import { CheckCircle, Target, Eye, Award, Users, BookOpen, Zap } from 'lucide-react';
...
const timeline = [
  { year: '2025', title: 'Founded', desc: 'Skillexa was started with just 3 courses and a passion to make quality tech education accessible.' },
  { year: '2025', title: 'Services Division', desc: 'Launched professional services including resume building, LinkedIn optimization, and design services.' },
  { year: '2025', title: '5,000+ Students community', desc: 'Expanded course catalog to 20+ courses across coding and career development.' },
  { year: '2026', title: 'Startup Support', desc: 'Launched startup growth consulting and business services division.' },
  { year: '2026', title: '10,000+ Students', desc: 'Reached milestone of 10,000+ students community. Growing every day.' },
];
    ...
    <Layout>
      ...
      <section className="py-20 bg-white dark:bg-gray-950">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <span className="inline-block text-blue-600 dark:text-blue-400 font-semibold text-sm uppercase tracking-wider mb-3">Our Story</span>
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-5">Born from a Student's Frustration</h2>
              <div className="space-y-4 text-gray-600 dark:text-gray-400 leading-relaxed">
                <p>Skillexa was founded in 2022 when our founders — fresh graduates themselves — realized that most coding courses taught theory but not the skills companies actually wanted. They saw friends struggling despite having degrees, lacking practical skills and career guidance.</p>
                <p>We built Skillexa to solve exactly this problem. A platform where students don't just learn to code — they build projects, optimize their professional profiles, get career mentorship, and access professional services all under one roof.</p>
                <p>Today, we've helped 12,000+ students land jobs, build businesses, and transform their lives. And we're just getting started.</p>
              </div>
            </div>
            <div className="grid grid-cols-2 gap-4">
              {[
                { icon: Users, label: 'Students community', value: '10,000+', color: 'blue' },
                { icon: BookOpen, label: 'Courses', value: '20+', color: 'indigo' },
                ...
                <div key={label} className={`card p-6 text-center border-t-4 border-${color}-500`}>
                  <Icon className={`w-8 h-8 text-${color}-600 dark:text-${color}-400 mx-auto mb-3`} />
      ...
      <section className="py-20 bg-white dark:bg-gray-950">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <span className="inline-block text-blue-600 dark:text-blue-400 font-semibold text-sm uppercase tracking-wider mb-3">Core Values</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {values.map(v => (
              <div key={v.title} className="card p-6">
                ...
                <h4 className="font-bold text-lg text-gray-900 dark:text-white mb-2">{v.title}</h4>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-5">The Skillexa Difference</h2>
      ...
      <section className="py-20 bg-gray-50 dark:bg-gray-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <span className="inline-block text-blue-600 dark:text-blue-400 font-semibold text-sm uppercase tracking-wider mb-3">Our Journey</span>
            <h2 className="section-title">The Skillexa Timeline</h2>
          </div>
          <div className="space-y-8 relative before:absolute before:left-6 before:top-0 before:bottom-0 before:w-0.5 before:bg-blue-200 dark:before:bg-blue-900">
            {timeline.map((item, i) => (
              <div key={i} className="flex gap-6 relative">
                ...
                <div className="card p-5 flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    <span className="text-xs font-semibold text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/40 px-2 py-1 rounded-full">{item.year}</span>
